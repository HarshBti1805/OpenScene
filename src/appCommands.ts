...
export function buildCommands(): AppCommand[] {
  ...
  return [
    ...
    { id: "theme.light", title: "Theme: Light", run: () => app().setTheme("light") },
    { id: "theme.dark", title: "Theme: Dark", run: () => app().setTheme("dark") },
    { id: "theme.midnight", title: "Theme: Midnight", run: () => app().setTheme("midnight") },
    numberingCmd("none"),
    numberingCmd("left"),
    numberingCmd("right"),
    numberingCmd("both"),
